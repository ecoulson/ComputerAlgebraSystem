...
namespace Mathematics.Tests.Calculus
{
    ...
    public class DerivativeTest
    {
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "2");
        //}

        //[Test]
        //public void Derive_2xy_Returns2y()
        //{
        //    Environment environment = new Environment();
        //    environment.AddSymbol("x");
        //    environment.AddSymbol("y");
        //    SyntaxNode node = Parser.ParseExpression("2xy", environment);
        //    Expression expression = new Expression(node, environment);
        //    Derivative derivative = new Derivative(expression, "x");

        //    Assert.AreEqual(derivative.Derive().ToString(), "2 * y");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "(19 + pi)");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "x + x");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "2 * x * 6 + 12 * x");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "2 * x");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "ln(3) * 3 ^ (2 * x) * 2");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "1 / x");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "x ^ x * (x * 1 / x + ln(x))");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "2 * x + 1");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "(x * 2 * x - x ^ 2) / x ^ 2");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "-1 * x ^ -2");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "cos(x)");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "-1 * sin(x)");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "sec(x) ^ 2");
        //}
        ...
        //    Assert.AreEqual(derivative.Derive().ToString(), "sec(x) * tan(x)");
        //}

        //[Test]
        //public void Derive_Cot_ReturnsSyntaxNode()
        //{
        //    Environment environment = new Environment();
        //    environment.AddSymbol("x");
        //    SyntaxNode node = Parser.ParseExpression("cot(x)", environment);
        //    Expression expression = new Expression(node, environment);
        //    Derivative derivative = new Derivative(expression, "x");

        //    Assert.AreEqual(derivative.Derive().ToString(), "csc(x) ^ 2");
        //}
    }
}
